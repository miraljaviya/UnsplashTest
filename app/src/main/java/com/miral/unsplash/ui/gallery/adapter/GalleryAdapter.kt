package com.miral.unsplash.ui.gallery.adapter
...
import com.miral.unsplash.databinding.ItemPhotoBinding
import com.miral.unsplash.utils.loadGridPhotoUrl
...
class GalleryAdapter(
    ...
    inner class GalleryViewHolder(
        ...
        fun bind(photo: Photo) = with(binding) {
            ...
            tvUserUsername.text = photo.user?.first_name
        }
    }
